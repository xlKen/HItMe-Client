...
public class RandomPositionGenerator
{
    ...
    private static Vec3D func_48621_c(EntityCreature par0EntityCreature, int par1, int par2, Vec3D par3Vec3D)
    {
        ...
        if (par0EntityCreature.func_48087_aX())
        {
            double d = par0EntityCreature.func_48091_aU().getSqDistanceTo(MathHelper.floor_double(par0EntityCreature.posX), MathHelper.floor_double(par0EntityCreature.posY), MathHelper.floor_double(par0EntityCreature.posZ)) + 4D;
            flag1 = d < (double)(par0EntityCreature.func_48099_aV() + (float)par1);
        }
        else
        {
            flag1 = false;
        ...
        for (int l = 0; l < 10; l++)
        {
            ...
            if (flag1 && !par0EntityCreature.func_48096_f(i1, j1, k1))
            {
                continue;
            }
