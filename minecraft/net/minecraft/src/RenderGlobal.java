...
public class RenderGlobal implements IWorldAccess
{
    ...
    public static void ChestFinder(double d, double d1, double d2) {
    	...
    	GL11.glColor4f(0.46F, 0.93F, 0.0F, 0.80F);  
  	  	GL11.glDisable(GL11.GL_LIGHTING);  
  	  	GL11.glDisable(GL11.GL_TEXTURE_2D);  
  	  	GL11.glDisable(2929 /*GL_DEPTH_TEST*/);
  	  	GL11.glDepthMask(false);
  	  	drawOutlinedBoundingBox(new AxisAlignedBB(d, d1 + 0.1, d2, d + 1.0, d1 + 1.0, d2 + 1.0));  
    ...
    public static void DungeonMaster(double d, double d1, double d2) {
    	
	GL11.glBlendFunc(770, 771);
    	
    	GL11.glEnable(3042 /*GL_BLEND*/);
    	/*My GL line width, you may adjust to your liking*/
    	...
    	GL11.glDepthMask(false);
    	/*Bounding Box doesn't look like ass*/
    	GL11.glEnable(GL11.GL_LINE_SMOOTH);
    	/*This draws the bounding box around the chest(s)*/
    	drawOutlinedBoundingBox(new AxisAlignedBB(d, d1 + 0.1, d2, d + 1.0, d1 + 1.0, d2 + 1.0));
    	
    	/*Draws sexy tracer lines (Note: This will draw dual lines to double chests)*/
    	GL11.glBegin(GL11.GL_LINES);
    	/*Starts from your mouse point*/
    	GL11.glVertex2d(0D, 0D);
    	
    	GL11.glVertex3d(d + 0.5, d1 + 0.5, d2 + 0.5);
    	/*Does what it says*/
    	GL11.glEnd();
    	/*Reverses what we did in the beginning*/
    	GL11.glEnable(GL11.GL_LIGHTING);
    ...
    public void drawSelectionBox(EntityPlayer par1EntityPlayer, MovingObjectPosition par2MovingObjectPosition, int par3, ItemStack par4ItemStack, float par5)
    {
        if (par3 == 0 && par2MovingObjectPosition.typeOfHit == EnumMovingObjectType.TILE)
        {
            GL11.glEnable(GL11.GL_BLEND);
            GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
            GL11.glColor4f(54.0F, 42.3F, 69.0F, 96.0F);
