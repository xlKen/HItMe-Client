...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.add(new GuiButton(69, width / 2 - 100, i + 108, stringtranslate.translateKey("Creator Website")));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        if (par1GuiButton.id == 69) {
        	...
        	try {      		
        		java.net.URI uri = new java.net.URI("http://www.diamondfacegrief.co.cc/");
        		desktop.browse(uri);
        	} 
        	catch(Exception e) {
