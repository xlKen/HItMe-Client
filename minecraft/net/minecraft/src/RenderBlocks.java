...
public class RenderBlocks
{
    ...
    public boolean renderBlockByRenderType(Block par1Block, int par2, int par3, int par4)
    {
        ...
        if (HitMe.Xray) {
            renderAllFaces = par1Block.blockID == 14 || par1Block.blockID == 15 ||par1Block.blockID == 16 || par1Block.blockID == 21 || par1Block.blockID == 54;
        }
    ...
    public boolean renderBlockFire(Block par1Block, int par2, int par3, int par4)
    {
        ...
        {
            double d8 = (double)par2 + 0.5D + 0.2D;
            double d9 = ((double)par2 + 0.5D) - 0.2D;
            double d12 = (double)par4 + 0.5D + 0.2D;
            double d14 = ((double)par4 + 0.5D) - 0.2D;
            double d16 = ((double)par2 + 0.5D) - 0.3D;
            double d18 = (double)par2 + 0.5D + 0.3D;
            double d20 = ((double)par4 + 0.5D) - 0.3D;
            double d22 = (double)par4 + 0.5D + 0.3D;
            ...
            d16 = ((double)par2 + 0.5D) - 0.4D;
            d18 = (double)par2 + 0.5D + 0.4D;
            d20 = ((double)par4 + 0.5D) - 0.4D;
            d22 = (double)par4 + 0.5D + 0.4D;
            tessellator.addVertexWithUV(d16, (float)par3 + f, par4 + 0, d, d4);
            tessellator.addVertexWithUV(d8, par3 + 0, par4 + 0, d, d6);
            tessellator.addVertexWithUV(d8, par3 + 0, par4 + 1, d2, d6);
            tessellator.addVertexWithUV(d16, (float)par3 + f, par4 + 1, d2, d4);
