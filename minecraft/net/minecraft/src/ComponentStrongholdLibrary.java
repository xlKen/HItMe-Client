...
public class ComponentStrongholdLibrary extends ComponentStronghold
{
    ...
    public ComponentStrongholdLibrary(int par1, Random par2Random, StructureBoundingBox par3StructureBoundingBox, int par4)
    {
        super(par1);
        coordBaseMode = par4;
        field_35058_a = getRandomDoor(par2Random);
        boundingBox = par3StructureBoundingBox;
        field_35057_c = par3StructureBoundingBox.getYSize() > 6;
    }
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        placeDoor(par1World, par2Random, par3StructureBoundingBox, field_35058_a, 4, 1, 0);
